...
%% FIGURE 2 %%
\figurePage{.9}{
	\includegraphics[page=1,width=18cm]{"supporting/scripts/benchmark/NODEBNGM/out/fig_predictions_o.pdf"}
}

%% FIGURE 3 %% 
\figurePage{.9}{
	\includegraphics[page=1,width=18cm]{"supporting/scripts/benchmark/NODEBNGM/out/fig_predictions_p.pdf"}
}

%% FIGURE 4 %% 
\figurePage{.9}{
	\includegraphics[page=1,width=18cm]{"supporting/scripts/benchmark/out/benchmark_overview.pdf"}
}
...
%% FIGURE 8 %%
\figurePage{.9}{
	\includegraphics[page=1,width=18cm]{"supporting/scripts/RStudio_Ushio/out/fig_DIN_v1.pdf"}
}
