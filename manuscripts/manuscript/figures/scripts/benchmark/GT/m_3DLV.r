...
## goal: generate artificial time series where true states, dynamics, effects, and contributions between species are known 

## method:
## Time series are generated by a tri-trophic ODE model
