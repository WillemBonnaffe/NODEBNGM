...
for(i in 1:N)
{
	...
	#
    ## legend
	legend("bottom",legend=c("Training","Validation")[1],col=colVect[1],lty=1,bty="n",cex=1.5,horiz=T,lwd=2)
	...
	#
	## legend
	legend("bottom",legend=c("Training","Validation")[2],col=colVect[2],lty=1,bty="n",cex=1.5,horiz=T,lwd=2)
