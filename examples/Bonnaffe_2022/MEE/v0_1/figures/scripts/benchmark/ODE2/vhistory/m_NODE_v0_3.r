...
{
  dY = nn.linear(Y,Beta[1:(I*O)],I,O) + nn.linear(as.vector(Y%*%t(Y)),Beta[-c(1:(I*O))],I*I,O)
  return(as.vector(dY))
}
...
## define model.dYdt
model.dYdt = function(t, Y, Beta) model.dYdt_NODE(t, Y, Beta, I=N, O=N)
