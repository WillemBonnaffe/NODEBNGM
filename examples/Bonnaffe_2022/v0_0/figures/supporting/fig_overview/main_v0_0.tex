...
\newcommand{\nnmodel}{
    \begin{tikzpicture}
        ...
        \def\x{4}
        \def\y{4}
        \node [draw,circle,scale=0.5,line width=\lwd,\col] (dxdt1) at (\x, \y) {$\partial t$};
        \node [draw,circle,scale=0.5,line width=\lwd,\col] (dxdt2) at (\x,-\y) {$\partial t$};
        \draw [line width=\lwd,\col] (p1i1.east) -- (dxdt1.west);
        \draw [line width=\lwd,\col] (p2i1.east) -- (dxdt2.west);
        %
        \def\x{5.75}
        \node [] (A) at (\x, 4) {};
        \node [draw,circle,scale=0.4,line width=\lwd,\col] (B) at (\x+1, 4) {$1/R$};
        \draw [line width=\lwd,\col] (A.east) -- (B.west);
        \node [] (A) at (\x, -4) {};
        \node [draw,circle,scale=0.4,line width=\lwd,\col] (B) at (\x+1, -4) {$1/N$};
        \draw [line width=\lwd,\col] (A.east) -- (B.west);
        ...
        \def\x{9}
        \def\y{1.5}
        \node [draw,circle          ,line width=\lwd,\col] (A) at (\x  ,  \y     ) {};
        \node [draw,circle,scale=0.4,line width=\lwd,\col] (B) at (\x+1,  \y+0.75) {$\partial R$};
        \draw [line width=\lwd,\col] (A.east) -- (B.west);
        \node [draw,circle          ,line width=\lwd,\col] (A) at (\x  ,  \y     ) {};
        \node [draw,circle,scale=0.4,line width=\lwd,\col] (B) at (\x+1,  \y-0.75) {$\partial N$};
        \draw [line width=\lwd,\col] (A.east) -- (B.west);
        \node [draw,circle          ,line width=\lwd,\col] (A) at (\x  ,  -\y     ) {};
        \node [draw,circle,scale=0.4,line width=\lwd,\col] (B) at (\x+1,  -\y+0.75) {$\partial R$};
        \draw [line width=\lwd,\col] (A.east) -- (B.west);
        ...
        \def\x{12}
        \def\y{1.5}
        \node [draw,circle          ,line width=\lwd,\col] (A) at (\x  ,   \y+0.75) {};
        \node [draw,circle,scale=0.5,line width=\lwd,\col] (B) at (\x+1,   \y+0.75) {$\times$};
        \draw [line width=\lwd,\col] (A.east) -- (B.west);% node [midway,above] {$\times dR/dt$};
        \node [draw,circle          ,line width=\lwd,\col] (C) at (\x  ,   \y-0.75) {};
        \node [draw,circle,scale=0.5,line width=\lwd,\col] (D) at (\x+1,   \y-0.75) {$\times$};
        \draw [line width=\lwd,\col] (C.east) -- (D.west);% node [midway,above] {$\times dN/dt$};
        %
        \def\y{4}
        \node [draw,circle,line width=\lwd,\col] (E) at (\x  ,   \y) {};
        \draw [line width=\lwd,\col] (E.east) -- (B.west);
        \node [draw,circle,line width=\lwd,\col] (F) at (\x  ,   -\y) {};
        \draw [line width=\lwd,\col] (F.east) -- (D.west);
