...
% \vspace{-0.5cm}
% \begin{equation}
%     \frac{dy_i}{dt} := \psi\left(y,\theta_i \right) \\
% \end{equation}
...
% \vspace{-0.5cm}
% \begin{equation}
%     \epsilon^{(o)}_{it}(\omega_i ~|~ Y_{it}) := Y_{it} - \tilde{y}_i(t,\omega_i)
% \end{equation}
...
% \vspace{-0.5cm}
% \begin{equation}
%     \epsilon^{(p)}_{it}(\Theta_i ~|~ \Omega) := \frac{\partial \tilde{N}_i}{\partial t} (t, \Omega_i) - \frac{dN_i}{dt} \left( \tilde{N},\Theta_i \right)
% \end{equation}
